...
exports.evaluatePredictionAction = void 0;
const LLM_PROVIDERS = [
    {
        name: "openai",
        model: "gpt-4"
...
async function callLLMProvider(runtime, provider, question, optionA, optionB) {
    const prompt = `
...
async function getConsensus(runtime, question, optionA, optionB, enabledProviders) {
    const responses = [];
...
exports.evaluatePredictionAction = {
    ...
    handler: async (runtime, message, state, options, callback) => {
        try {
            ...
            const consensus = await getConsensus(runtime, content.question, content.optionA, content.optionB, content.providers);
